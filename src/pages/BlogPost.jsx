...
const blogPosts = {
  'angkor-wat': {
    ...
    additionalContent: {
      ...
      polaroidImages: [
        { src: 'https://i.postimg.cc/Y0VCfn6n/blue-lagoon-bambas-rojas.jpg', title: 'Polaroid 1', description: 'Descripción corta 1' },
        { src: 'https://i.postimg.cc/Y0VCfn6n/blue-lagoon-bambas-rojas.jpg', title: 'Polaroid 2', description: 'Descripción corta 2' },
        { src: 'https://i.postimg.cc/Y0VCfn6n/blue-lagoon-bambas-rojas.jpg', title: 'Polaroid 3', description: 'Descripción corta 3' }
      ]
    }
  },
  'zaanse-schans': {
          ...
          <Carousel.Item key={index}>
            <div className="polaroid-inner">
              {chunk.map((polaroid, idx) => (
                <div key={idx}>
                  <div className="polaroid-card" onClick={() => handlePolaroidClick(polaroid)}>
                    <img
                      className="d-block w-100"
                      src={polaroid.src}
                      alt={polaroid.title}
